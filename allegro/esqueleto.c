/* Esqueleto de game com Allegro 5
 * Autor: Isaac Franco Fernandes
 * Para compilar: gcc esqueleto.c -o esqueleto -lallegro -lallegro_primitives
 */
	...
	while ( !sair ) {
		...
		switch (evento_atual.type) {
			...
			case ALLEGRO_EVENT_KEY_DOWN:
				printf("Tecla pressionada: %i\n", evento_atual.keyboard.)
			default:
